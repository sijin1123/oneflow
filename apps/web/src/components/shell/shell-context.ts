const workspaceRouteLabels: Array<{ path: string; title: string; parent: string }> = [
  ...
  { path: '/ai', title: 'OneFlow AI', parent: 'AI workspace' },
  ...
  { path: '/admin/project-configuration', title: '프로젝트 구성', parent: '워크스페이스 설정' },
  { path: '/admin/project-phases', title: '프로젝트 단계', parent: '워크스페이스 설정' },
  { path: '/admin/project-roles', title: '프로젝트 역할', parent: '워크스페이스 설정' },
