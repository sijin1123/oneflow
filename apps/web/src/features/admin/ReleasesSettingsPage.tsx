...
export function ReleasesSettingsPage() {
  ...
  return (
    <SettingsFrame
      ...
      title="Releases"
      description="마일스톤 기반 릴리스 계획 기능을 워크스페이스 전체에서 관리합니다."
      meta={`정책 revision ${data.revision}`}
    >
      <SettingsSection
        title="Releases 사용"
        description="끄면 릴리스 API와 마일스톤 선택·저장된 릴리스 필터·포트폴리오 타임라인의 릴리스 정보가 숨겨집니다. 저장된 마일스톤과 작업 연결은 삭제되지 않으며, 다시 켜면 그대로 사용할 수 있습니다."
      >
