...
type WorkPackageRowActionsProps = {
  projectId: string
  wp: WorkPackage
  canWrite: boolean
  onOpenDrawer: (id: string) => void
  onOpenMove: (id: string) => void
  onMessage: (message: RowActionMessage) => void
}
...
export function WorkPackageRowActions({
  projectId,
  wp,
  canWrite,
  onOpenDrawer,
