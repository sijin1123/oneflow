...
export interface paths {
    ...
    "/api/v1/projects/{project_id}/intake/{item_id}/history/{history_id}/actor-image": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /** Get Intake Decision History Actor Profile Image */
        get: operations["get_intake_decision_history_actor_profile_image_api_v1_projects__project_id__intake__item_id__history__history_id__actor_image_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v1/projects/{project_id}/schedule-baseline": {
        ...
        /** Get Project Schedule Baseline */
        get: operations["get_project_schedule_baseline_api_v1_projects__project_id__schedule_baseline_get"];
        /** Capture Project Schedule Baseline */
        put: operations["capture_project_schedule_baseline_api_v1_projects__project_id__schedule_baseline_put"];
        post?: never;
        /** Delete Project Schedule Baseline */
        delete: operations["delete_project_schedule_baseline_api_v1_projects__project_id__schedule_baseline_delete"];
        options?: never;
        head?: never;
        patch?: never;
        trace?: never;
    ...
    "/api/v1/workspace-invitations/preview": {
        ...
        post: operations["preview_workspace_invitation_api_v1_workspace_invitations_preview_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/workspace-invitations/{invitation_id}": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        delete: operations["revoke_workspace_invitation_api_v1_workspace_invitations__invitation_id__delete"];
        options?: never;
        head?: never;
        patch?: never;
        trace?: never;
    };
    "/api/v1/workspace-invitations/{invitation_id}/rotate": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        get?: never;
        put?: never;
        /** Rotate Workspace Invitation */
        post: operations["rotate_workspace_invitation_api_v1_workspace_invitations__invitation_id__rotate_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export interface components {
    schemas: {
        ...
        ProjectScheduleBaselineSummary: {
            /** Added */
            added: number;
            baseline: components["schemas"]["ProjectScheduleBaselineRead"] | null;
            /** Changed Total */
            changed_total: number;
            /** Current Total */
            current_total: number;
            ...
            earlier: number;
            /** Items */
            items: components["schemas"]["ProjectScheduleVarianceItem"][];
            /** Items Truncated */
        ...
        ProjectScheduleVarianceItem: {
             ...
             * @enum {string}
             */
            state: "unchanged" | "later" | "earlier" | "unscheduled" | "rescheduled" | "added" | "removed";
            /** Subject */
            subject: string;
            /** Variance Days */
...
export interface operations {
    ...
    get_intake_decision_history_actor_profile_image_api_v1_projects__project_id__intake__item_id__history__history_id__actor_image_get: {
        parameters: {
            query?: {
                version?: string | null;
            };
    ...
    get_project_schedule_baseline_api_v1_projects__project_id__schedule_baseline_get: {
        parameters: {
            query?: never;
            header?: {
                authorization?: string | null;
    ...
    capture_project_schedule_baseline_api_v1_projects__project_id__schedule_baseline_put: {
        parameters: {
            query?: never;
            header?: {
                authorization?: string | null;
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["ProjectScheduleBaselineMutation"];
            };
        };
        responses: {
            /** @description Successful Response */
    ...
    delete_project_schedule_baseline_api_v1_projects__project_id__schedule_baseline_delete: {
        parameters: {
            query: {
                expected_version: number;
            };
    ...
    create_workspace_invitation_api_v1_workspace_invitations_post: {
        ...
        responses: {
            ...
            201: {
                ...
                content: {
                    "application/json": components["schemas"]["WorkspaceInvitationSecret"];
                };
            };
            /** @description Forbidden */
            403: {
    ...
    accept_workspace_invitation_api_v1_workspace_invitations_accept_post: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["WorkspaceInvitationToken"];
            };
        };
        responses: {
            /** @description Successful Response */
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["WorkspaceInvitationAccepted"];
                };
            };
            /** @description Not Found */
            404: {
    ...
    preview_workspace_invitation_api_v1_workspace_invitations_preview_post: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["WorkspaceInvitationPreview"];
                };
            };
            /** @description Not Found */
            404: {
    ...
    revoke_workspace_invitation_api_v1_workspace_invitations__invitation_id__delete: {
        parameters: {
            query: {
                expected_version: number;
            };
    ...
    rotate_workspace_invitation_api_v1_workspace_invitations__invitation_id__rotate_post: {
        parameters: {
            query?: never;
            header?: {
                authorization?: string | null;
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["WorkspaceInvitationMutation"];
            };
        };
        responses: {
            /** @description Successful Response */
